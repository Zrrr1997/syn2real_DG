...
class Generator(nn.Module):
    ...
    def forward(self, x, c):
        ...
        c = c.repeat(1, 1, x.size(2), x.size(3)) # class label with domain information shape ------> (batch_size, K_n + K_s = 2 * #domains, w, h) -> expanded spatially
        x = torch.cat([x, c], dim=1) # Channels are 2*#domains + 3
