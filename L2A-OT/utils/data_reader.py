...
from utils.utils import unfold_label, shuffle_data
...
class BatchImageGenerator:
    ...
    def load_data(self, b_unfold_label):
        ...
        self.images = np.transpose(self.images, (0, 3, 1, 2))   # shape is ----> (#samples, #channels, h, w)
        #print("Loaded images shape:", self.images.shape)
    ...
    def get_images_labels_batch(self): # read samples sequentially with a local counter - reshuffle when counter reaches number of all samples
