    ...
    def __getitem__(self, index): # -> T_co:
        ...
        if "vclip" in self.return_data:
            ...
            for i in range(len(self.modalities)):
                ...
                seq_vid_all_modalities.append(gad_v.frame_loader(frame_indices_vid[0],  os.path.join(self.dataset_roots[i], sample["vid_path_modality_"+str(i+1)], self.modalities[i] + suffix), self.n_channels_each_modality[i], self.modalities[i], self.color_jitter, self.color_jitter_trans))
